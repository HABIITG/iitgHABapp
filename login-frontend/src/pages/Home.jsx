...
export default function Home() {
        ...
        if (response.ok) {
          ...
          if (Array.isArray(hostels)) {
            ...
            const carouselImgs = hostels
              .map(hostel => {
                const hostelName = (hostel.hostel_name || hostel.name).toLowerCase().replace(/\s+/g, '');
            ...
            setCarouselImages(carouselImgs.length > 0 ? carouselImgs : [
  ...
  const contributors = [
    {
      ...
      description: "Overseeing hostel affairs, managing policies, and coordinating with different hostels across campus.",
    },
    {
      icon: UsersIcon,
      title: "Hostel Management Committees",
      description: "Managing day-to-day operations, student welfare, and ensuring smooth hostel functioning.",
    },
    {
      icon: BuildingOfficeIcon,
      title: "Hostel Administrators",
      description: "Handling administrative tasks, student records, and operational management efficiently.",
    },
  ];
        ...
        try {
          ...
          if (hostelResponse.ok) {
            ...
            if (Array.isArray(hostelData)) {
              const totalStudents = hostelData.reduce((sum, hostel) => sum + (hostel.user_count || 0), 0);
              if (totalStudents > 0) {
                setLiveStats(prev => ({
                  ...prev,
          ...
          console.warn("Error fetching hostel data for user count:", hostelError);
        }
  ...
  const stats = [
    ...
    { icon: CheckCircleIcon, value: liveStats.complaintsResolved, label: "Complaints Resolved" },
  ];
  ...
  const blogPosts = [
    {
      ...
      description: "How HABit is transforming hostel administration and making student services more accessible.",
      image: "/api/placeholder/400/300",
    },
    {
      title: "Digital Transformation in Campus Living",
      description: "The impact of technology on student housing and accommodation services at IIT Guwahati.",
      image: "/api/placeholder/400/300",
    },
    {
      title: "Student Services Made Easy",
      description: "Simplifying access to forms, applications, and administrative processes for all students.",
      image: "/api/placeholder/400/300",
    },
  ];
            ...
            <div className="max-w-3xl">
              ...
              <div className="mb-10">
                <h1 className="text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
                  ...
                  <span className="text-[#6149CD]" style={{ WebkitTextStroke: '1.5px black', textStroke: '1.5px black', paintOrder: 'stroke fill' }}>Simplified</span>
                </h1>
                <p className="text-xl text-white/95 mb-8">
                  Streamlining hostel management at IIT Guwahati with innovative digital solutions for students and administrators.
                </p>
              </div>
              ...
              <div className="flex flex-wrap gap-4">
                <a
                  href="https://apps.apple.com/app/habit-iitg/id6739000000"
                  target="_blank"
                ...
                >
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="text-sm sm:text-lg font-semibold leading-tight">App Store</span>
                  </div>
                </a>
                <a
                ...
                >
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="text-sm sm:text-lg font-semibold leading-tight">Google Play</span>
                  </div>
                </a>
              </div>
            </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-8 sm:px-12 lg:px-16 xl:px-20">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">All Hostels at IIT Guwahati</h2>
            <p className="text-lg text-gray-600">
              Serving all {hostelLogos.length || 12} hostels with comprehensive management solutions
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-10 gap-12 items-center">
            ...
            <div className="lg:col-span-7">
              <p className="text-lg text-gray-700 mb-6 leading-relaxed">
                "As the Admin of Hostel Affairs Board at IIT Guwahati, my love for our students drives everything I do. I wanted to make all the students' work easy and streamline their hostel experience. HABit represents our commitment to simplifying administrative processes and ensuring that every student can focus on what matters most - their education and growth. This platform is built with care, understanding, and a deep desire to serve our student community better."
              </p>
              <div className="mb-6">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-10 gap-12 items-center">
            <div className="lg:col-span-7 order-2 lg:order-0">
              <p className="text-lg text-gray-700 mb-6 leading-relaxed">
                "As the General Secretary of Hostel Affairs Board, IIT Guwahati, my vision is to streamline everything using modern technology to provide faster and quicker service to the Hostel residents. HABit embodies this vision - leveraging cutting-edge digital solutions to transform how we manage hostel affairs. By embracing technology, we're not just modernizing processes; we're creating a more responsive, efficient, and student-friendly environment. This platform ensures that every hostel resident receives prompt, reliable service, making their campus life smoother and more enjoyable."
              </p>
              <div className="mb-6">
                <div className="text-xl font-semibold text-[#6149CD] mb-1">
                  Harshit Tomar
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl font-bold text-gray-900 mb-4">
                ...
                <span className="text-[#6149CD]">transforming hostel management</span>
              </h2>
              <p className="text-lg text-gray-600">
      ...
      <section className="py-20 px-8 sm:px-12 lg:px-16 xl:px-20">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-10 gap-12 items-center">
            ...
            <div className="lg:col-span-7">
              <p className="text-lg text-gray-700 mb-6 leading-relaxed">
                Coding Club IIT Guwahati is a student-led team of developers who developed HABit IITG. Our vision is to support student bodies in providing tech support so that they can provide their services in a better way to the Campus. We believe that technology should serve the community, and HABit is our contribution to making hostel management more efficient, transparent, and student-friendly. By collaborating with the Hostel Affairs Board and other student bodies, we're creating digital solutions that truly make a difference in campus life.
              </p>
              <div className="mb-6">
                <div className="text-xl font-semibold text-[#6149CD] mb-1">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Stay informed about the latest developments in hostel management, platform updates, and important announcements from the Hostel Affairs Board.
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
